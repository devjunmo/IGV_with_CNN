...
root_path = r'/myData/UTUC_data/gdc_hg38/maf/2nd_re/DP_AF_filtered_maf/exclude_filterTag_utuc'
# root_path = r'E:/UTUC_data/gdc_hg38/maf/5th/DP_AF_filtered_maf/exclude_filterTag_utuc'
# root_path = r'/myData/stemcell_ips/gdc/clone/hips29/clone_comp/snapshot'
...
for input_csv_path in input_csv_path_lst:
    ...
    output_dir = os.path.join(root_path, f_name)
    ...
    output_bed_path = os.path.join(output_dir, output_bed_name)
