...
input_img_root = r'E:/stemcell_ips/HAP_MUT2_compare/unfiltered/just_ac_apply_comp/tech_comp/igv_img_NP/tech2_opp'
snapshot_format = r'NP_only/*.png'

output_bed_name = 'hips29-A_tech2_NA_igv.bed'

input_img_path = os.path.join(input_img_root, snapshot_format)
output_bed_path = os.path.join(input_img_root, output_bed_name)

# print(sample_dirs)


# print("첫 루프")
img_path_lst = glob(input_img_path)
...
bed_df.to_csv(output_bed_path, index=False, header=None, sep="\t")
